...
TASKS_URL="$WORKSPACES_URL/$JIRA_MAIN_WORKSPACE_ID/projects/$STORIES_ID/tasks"
...
ADD_ENTRY_URL="https://api.clockify.me/api/v1/workspaces/$JIRA_MAIN_WORKSPACE_ID/time-entries"
